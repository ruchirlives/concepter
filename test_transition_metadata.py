...
def test_save_transition_metadata():
    ...
    try:
        response = requests.post(
            f"{API_BASE_URL}/save_transition_metadata",
            headers=headers,
            json={"metadata": test_metadata}
        )
...
def test_load_transition_metadata():
    ...
    try:
        response = requests.get(
            f"{API_BASE_URL}/load_transition_metadata",
            headers=headers
        )
...
def test_delete_transition_metadata():
    ...
    try:
        response = requests.delete(
            f"{API_BASE_URL}/delete_transition_metadata",
            headers=headers
        )
